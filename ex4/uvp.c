...
)
{
    for (int i=1;i<imax;i++){
        for (int j=1;j<=jmax;j++){
            ...
            //if ((Flag[i][j]>511)&&(Flag[i+1][j]>511)){
                F[i][j]=U[i][j]+dt*(
            ...
            //Obstacles case
            //else{
                if ((Flag[i][j]<=511)&&((Flag[i][j]&2)==2)){//W
                    F[i-1][j]=U[i-1][j];
                }
                if ((Flag[i][j]<=511)&&((Flag[i][j]&1)==1)){//E
                    F[i][j]=U[i][j];
                }
            //}
        }
    ...
    for (int i=1;i<=imax;i++){
        for (int j=1;j<jmax;j++){
            //Only take place on edges between 2 fluid cells
            //if ((Flag[i][j]>511)&&(Flag[i][j+1]>511)){
                G[i][j]=V[i][j]+dt*(
            ...
            //Obstacle case
            //else{
                if ((Flag[i][j]<=511)&&((Flag[i][j]&8)==8)){//N
                    G[i][j]=V[i][j];
                }
                if ((Flag[i][j]<=511)&&((Flag[i][j]&4)==4)){//S
                    G[i][j-1]=V[i][j-1];
                }
            //}    
        }
